...
public class Installer
{
    public void Install()
    {
        ...
        config.RunningMsg = "SquadJs is running.";
        config.Process2Watch = "node";
        config.SecUntilScan = 1800;//30min
        config.AccessRoles = new ulong[] { 1083877284710203536/*Server Tech*/, 1157739577272959096/*Server Admin*/,1034920153235857418/*DIVCOM*/,1043876467341271080/*BATCOM*/}; //RoleID's
